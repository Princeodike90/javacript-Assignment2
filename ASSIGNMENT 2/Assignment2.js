const utme2024Students = [
  ...
  const firstNamesAndScore = utme2024Students.map((each)=>{
    return `${each.firstName} ${each.score}`
  })

  console.log(firstNamesAndScore)
 ...
 const totalStudents = utme2024Students.length;
 const totalScores = utme2024Students.reduce((sum, student) => sum + student.score, 0);
